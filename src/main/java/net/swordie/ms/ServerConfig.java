...
public class ServerConfig {
    ...
    public static final String EVENT_MSG = String.format("#bPoki v205\r\n#kadd Poki6969 on discord for support", ServerConstants.VERSION, ServerConstants.MINOR_VERSION);
